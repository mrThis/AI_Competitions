...
implement = pd.read_csv('../data/output/implement_test.csv')
# 单独的药品项目类目
# shape (4079851, 2)
...
#根据病人id
gdp = implement[['FTR51_1', 'FTR51_2', 'FTR51_3', 'FTR51_4', 'FTR51_5']].groupby('PERSONID')
...
# 3_1新实现了频率
# 输出FTR51_4，实现了TODO
dff.to_pickle('../data/input/FTR51test.p')
